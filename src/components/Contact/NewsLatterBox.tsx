...
const NewsLatterBox = () => {
  ...
  return (
    <div style={{direction:"rtl"}} className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 style={{textAlign:"center"}} className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        الانضمام لفريق المطورين  بالشركة
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        هل تريد أن تصبح أحد أعضاء فريق المطورين داخل الشركة؟
      </p>
      <div>
        <input
          type="text"
        ...
        <input
          type="submit"
          value="اشترك الان ولا تضيع الفرصة !"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
        />
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          اشترك الان واغتنم الفرصة لتصبح أحد اعضاء الفريق وتتمتع بالمزايا
        </p>
      </div>
